...
public class FluidRegistryContainer {
    ...
    // add these to fix missing references
    private final Supplier<IClientFluidTypeExtensions> clientExtensions;
    ...
    public FluidRegistryContainer(String name, FluidType.Properties typeProperties, Supplier<IClientFluidTypeExtensions> clientExtensions, BlockBehaviour.Properties blockProperties, Item.Properties itemProperties) {
    ...
    public FluidRegistryContainer(String name, FluidType.Properties typeProperties,
                                  ...
                                  Item.Properties itemProperties, Supplier<IClientFluidTypeExtensions> clientExtensions1, BlockBehaviour.Properties blockProperties1, Item.Properties itemProperties1) {
        this(name, typeProperties, (Supplier<IClientFluidTypeExtensions>) itemProperties1, blockProperties1, (Item.Properties) clientExtensions1);
    }
    ...
    public static class ClientExtensions {
        ...
        public ClientExtensions flowing(String name, String folder) {
            this.flowing = new ResourceLocation(AutomationExpansion.MODID, "/pentafluro_water_flow");
            return this;
        }
        ...
        public ClientExtensions overlay(String name, String folder) {
            this.overlay = new ResourceLocation(AutomationExpansion.MODID, folder + "/pentafluro_water_still");
            return renderOverlay(new ResourceLocation(this.modid, "textures/fluid/pentafluro_water_still"));
        }
